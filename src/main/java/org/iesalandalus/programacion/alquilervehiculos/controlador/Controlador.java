...
public class Controlador {
    ...
    public void insertar(Turismo turismo) throws OperationNotSupportedException {
        this.modelo.insertar(turismo);
    }

    public void insertar(Alquiler alquiler) throws OperationNotSupportedException {
        this.modelo.insertar(alquiler);
    }
    ...
    public void modificar(Cliente cliente, String nombre, String telefono) throws OperationNotSupportedException {
        this.modelo.modificar(cliente, nombre, telefono);
    }

    public void devolver(Alquiler alquiler, LocalDate fechaDevolucion) throws OperationNotSupportedException {
        this.modelo.devolver(alquiler, fechaDevolucion);
    }
    ...
    public void borrar(Turismo turismo) throws OperationNotSupportedException {
        this.modelo.borrar(turismo);
    }

    public void borrar(Alquiler alquiler) throws OperationNotSupportedException {
        this.modelo.borrar(alquiler);
    }
